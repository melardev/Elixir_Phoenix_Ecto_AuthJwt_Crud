defmodule ApiPhoenixJwtCrud.AuthTest do
  ...
  describe "users" do
    ...
    @update_attrs %{email: "some updated email", hashed_password: "some updated hashed_password", username: "some updated username"}
